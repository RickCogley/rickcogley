...
**1039** commits &nbsp;|&nbsp; **578** this week &nbsp;|&nbsp; 🔥 **13**-day streak

**Languages:** TypeScript (10) · SCSS (2) · HTML (1) · Svelte (1) · Bicep (1)
**Active repos (10):** `eSolia/codex` `eSolia/esolia-2025` `RickCogley/dotfiles` `eSolia/blog.esolia.pro` `eSolia/periodic` and 5 more
