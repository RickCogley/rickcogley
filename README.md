...
**814** commits &nbsp;|&nbsp; **308** this week &nbsp;|&nbsp; 🔥 **29**-day streak

**Languages:** TypeScript (3) · Shell (2) · HTML (1) · PowerShell (1) · Python (1)
**Active repos (4):** `eSolia/codex` `eSolia/nexus` `RickCogley/dotfiles` `eSolia/esolia-2025`
