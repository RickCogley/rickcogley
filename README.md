...
**1103** commits &nbsp;|&nbsp; **449** this week &nbsp;|&nbsp; 🔥 **29**-day streak

**Languages:** TypeScript (10) · SCSS (2) · Svelte (2) · Bicep (1) · CSS (1)
**Active repos (9):** `eSolia/codex` `eSolia/nexus` `eSolia/esolia-2025` `eSolia/blog.esolia.pro` `eSolia/periodic` and 4 more
